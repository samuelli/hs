...
`echo "Hi $name,\n\nThank you for registering your interest in UNSW High School Computing Club.\n\nAny queries you may have can be sent to csesoc.computerclub\@cse.unsw.edu.au. Please do not reply to this email directly.\n\nRegards,\nUNSW High School Computing Club\n" | mail -aFrom:csesoc.computerclub\@cse.unsw.edu.au -s "Computing Club" $email`;
